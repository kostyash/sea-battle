...
export default defineConfig({
  test: {
    ...
    // Тесты-свойства перебирают тысячи расстановок и партий: это честная работа
    // процессора, а не зависание. Бегунок CI втрое медленнее ноутбука, и стандартных
    // пяти секунд ему не хватает.
    testTimeout: 15_000,
    coverage: {
      provider: 'v8',
      thresholds: gate
